...
/** Model class for benchmark functionality Handles data operations and business logic */
class BenchmarkModel {
    ...
    fun startBenchmark(
        ...
        if (selectedModelId.isNullOrEmpty()) {
            callback.onBenchmarkModelError(
                    BenchmarkErrorCode.MODEL_ERROR,
        ...
        try {
            ...
            val runtimeParams =
                    BenchmarkService.defaultRuntimeParams.copy(
            ...
            val testParams =
                    BenchmarkService.defaultTestParams.copy(
            ...
            MemoryMonitor.reset()
            callback.onBenchmarkModelError(
                    BenchmarkErrorCode.BENCHMARK_FAILED_UNKOWN,
